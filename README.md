...
| `docs/media/` | Media stack documentation | ✅ |
| `docs/docker/` | Docker documentation | 🚧 Planned |
| `docs/networking/` | Home network documentation | 🚧 Planned |
| `docs/monitoring/` | Monitoring documentation | 🚧 Planned |
